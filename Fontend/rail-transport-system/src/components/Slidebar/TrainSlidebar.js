        ...
        <div className='train-slidebar'>
            ...
            <Carousel.Item>
                <img
                  ...
                  alt="First slide"
                  style={{height:'70vh', width:'100vw',backgroundColor:'grey',objectFit:'cover'}}
                />
                <Carousel.Caption>
                <img src="../images/RTS=LOGO2.png" style={{height:'60vh',objectFit:'contain'}} /> 
              ...
              <Carousel.Item>
                ...
                />
                <Carousel.Caption>
                <img src="../images/BTS-Logo.png" style={{height:'60vh',objectFit:'contain'}} /> 
                  <h3 >Bangkok Mass Transit System</h3>
                  <p >Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
                </Carousel.Caption>
              </Carousel.Item>
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                <img src="../images/MRT-Logo.png" style={{height:'60vh',objectFit:'contain'}}/>  
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                <img src="../images/ARL-Logo.png" style={{height:'60vh',objectFit:'contain'}}/> 
